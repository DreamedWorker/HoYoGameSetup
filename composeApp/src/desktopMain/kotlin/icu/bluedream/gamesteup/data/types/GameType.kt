...
enum class GameType {
    ...
    companion object {
        ...
        fun getPackInfoDownloadLink(type: GameType): String = when(type) {
            GI_CN -> GENSHIN_PKG_API_CN
            GI_OS -> GENSHIN_PKG_API_GL
            ZZZ_CN -> ZZZ_PKG_API_CN
            ZZZ_OS -> ZZZ_PKG_API_GL
        }
