...
import icu.bluedream.gamesteup.viewmodel.UseExistsViewModel
import org.jetbrains.compose.resources.painterResource
import org.jetbrains.compose.resources.stringResource

class UseExistsView(private val installConfig: HomeUiState) : Screen {

    @OptIn(ExperimentalMaterial3Api::class)
    @Composable
    override fun Content() {
        val viewModel = rememberScreenModel { UseExistsViewModel() }
        ...
        Scaffold(
            ...
            topBar = {
                TopAppBar(
                    title = { Text(stringResource(Res.string.exists_title)) },
                    navigationIcon = {
            ...
            Column(
                ...
                Column(
                    ...
                    Text(
                        stringResource(Res.string.exists_tip),
        ...
        LaunchedEffect(Unit) {
            viewModel.startTask(installConfig) {
